...
label start:
    ...
    label stygian_blue_intro:
        ...
        l "Но потом другие чуваки доказали, что эти \"запретные цвета\" никто таки не видит."
        ...
        l "И вот на этой оптимистичной ноте действительно всё. Ставьте пальчики вверх, подписывайтесь на канал."
        label set_pers:
